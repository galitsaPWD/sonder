...
async function loadInitialData() {
    ...
    try {
        ...
        console.log('2. Loading Recent Readings Widget...');
        await window.dbOperations.loadRecentReadingsWidget();
        window.dbOperations.initializeRealtimeReadingsWidget();
        
        console.log('3. Refreshing Customers...');
        await refreshCustomers();
        
        console.log('4. Loading Staff...');
        await window.dbOperations.loadStaff();
        
        console.log('5. Loading Billing...');
        await refreshBilling();
        
        console.log('6. Loading Area Boxes...');
